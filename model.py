...
dataset = pd.read_csv('BalochistanDistrict.csv') #Reading from folder where csv file is
...
#Splitting the dataset, 27% for test set
...
print(regressor.predict([[2020, 130]]))
